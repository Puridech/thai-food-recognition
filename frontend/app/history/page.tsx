  ...
  const filterHistory = () => {
    ...
    if (searchQuery) {
      filtered = filtered.filter(item =>
        formatFoodName(item.food_name).toLowerCase().includes(searchQuery.toLowerCase())
      );
    }
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              {history.length} {history.length === 1 ? 'search' : 'searches'} found
            </p>
          </div>
            ...
            <div className="text-center py-16 bg-white rounded-lg border-2 border-dashed border-gray-300">
              ...
              <p className="text-gray-600">
                {searchQuery 
                  ...
                  : 'Start recognizing Thai food to build your history!'}
              </p>
              {searchQuery && (
                <button
              ...
              {filteredHistory.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-gray-900 text-xl mb-2 truncate group-hover:text-primary-600 transition-colors">
